...
import { aminoAcids, intraWorkout, preWorkout, proteinPowder, weightManagement } from '../assets';
import { useIntersectionObserver } from '../hooks/useIntersectionObserver';
import './SupplementForGoalsSection.css';

const goalCards = [
    { label: 'protein powder', image: proteinPowder, href: '/collections/protein-powder' },
    { label: 'pre-workout', image: preWorkout, href: '/collections/pre-workout' },
    { label: 'intra-workout', image: intraWorkout, href: '/collections/intra-workout' },
    { label: 'amino acids', image: aminoAcids, href: '/collections/amino-acids' },
    { label: 'weight management', image: weightManagement, href: '/collections/weight-management' },
];
...
function GoalCard({ item, delayIndex = 0, size }) {
    ...
    const dimensions = size === 'large'
        ? { width: 600, height: 342, minClass: 'min-h-[200px] md:min-h-[224px] lg:min-h-[280px]' }
        : { width: 436, height: 220, minClass: 'min-h-[140px] md:min-h-[160px] lg:min-h-[200px]' };
