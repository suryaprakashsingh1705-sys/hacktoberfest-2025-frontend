...
export default function CollectionPage() {
  ...
  const collectionTitle = currentCollection?.replace(/-/g, ' ') || 'Collection';
      ...
      <>
        ...
        <main className="min-h-screen bg-[#F7FAFF] flex items-center justify-center">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center max-w-md mx-4">
            ...
            <button
              onClick={() => dispatch(fetchCollectionById(id))}
  ...
  const imageUrl = collections.find((col) => col.id === id)?.image || null;
