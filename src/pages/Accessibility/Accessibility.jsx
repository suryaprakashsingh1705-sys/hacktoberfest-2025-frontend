            ...
            <div className="grid md:grid-cols-2 gap-4">
              <article className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">
                  Compatible with JAWS, NVDA, VoiceOver, and other screen
                  reading software.
                </p>
              </article>
              ...
              <article className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">
                  Supports Dragon NaturallySpeaking and other voice control
                  software.
                </p>
              </article>
          ...
          <section className="bg-white rounded-lg shadow-sm p-6 md:p-8">
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-blue-800 text-sm">
                <strong>Last Updated:</strong> This accessibility statement was
