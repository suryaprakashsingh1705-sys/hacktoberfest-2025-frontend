  ...
  const lastProductElementRef = useCallback(node => {
    ...
    observer.current = new IntersectionObserver(entries => {
      if (entries[0].isIntersecting && hasMoreProducts) {
        setDisplayedCount(prevCount => Math.min(prevCount + 5, allProducts.length));
      }
    });
      ...
      <main className="min-h-screen" style={{ backgroundColor: '#F7FAFF' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
                Discover our complete range of premium sports nutrition supplements designed to fuel your fitness journey
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center">
            ...
            <button
              className="flex items-center gap-2 bg-transparent text-gray-700 px-6 py-3 rounded-lg font-medium border border-gray-300 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all duration-300"
            >
              All Filters
            ...
            <div className="w-full">
              {error && (
                <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center">
                  ...
                  <button
                    onClick={() => dispatch(fetchProducts({ page: 1, limit: 1000 }))}
